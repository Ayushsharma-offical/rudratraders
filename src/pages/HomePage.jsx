...
const HomePage = () => {
  ...
  useEffect(() => {
    if (document.getElementById('home-btn-styles')) return;
    const style = document.createElement('style');
    style.id = 'home-btn-styles';
    style.textContent = `
      .btn-glow-coral {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="pt-10">
              ...
              <div className="flex flex-wrap gap-4">
                <button onClick={() => navigate('/products')} className="btn-glow-coral">
                  Explore Catalog
                </button>
                <button onClick={() => navigate('/cart')} className="btn-glow-white">
